...
- 🟡 §1.9 README polish + §4.2.5 + §4.2.8 + §4.2.10 + §4.2.11 + §4.2.12 + §4.2.14. **Polish pass**: 48 em-dashes cleared. **§4.2.5**: surface table 12 → 16. **§4.2.8**: engineering tour added. **§4.2.10**: Wave 4 history. **§4.2.11**: Live deployments adds 4 Wave 4 contracts. **§4.2.12**: Security posture refreshed (4 new rows + 2 tightened). **§4.2.14**: Get started enriched with "Try a Wave 4 feature in 60 seconds" routes + 4 local CI commands (storage:check, vitest run, tsc -p api/tsconfig.json, hardhat compile+test). README voice: 0 em-dashes, 0 banned words. Remaining §4 sections (4.2.1 Hero polish only) deferred.
