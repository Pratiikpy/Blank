...
- 🟡 §1.9 README polish + §4.2.8 + §4.2.5 + §4.2.10 Wave 4 history. **Polish pass**: 48 em-dashes cleared, Wave 4 summary entry added (audit iter 15 closed). **§4.2.8**: new "What is actually novel here" section (11-file passkey-AA flow + 3 engineering choices + BusinessHub pattern + 5 privacy defaults). **§4.2.5 refresh**: surface table 12 → 16, "Send any of these links" updated with 4 new URL formats. **§4.2.10**: Wave 3 date corrected (May 1 to May 9, was the impossible "May 1 to Apr 30"); new Wave 4 history section with 4-contract overview, FHE pipeline UI, audit-iter-10 fix narrative, storage coverage 100%, CI uplift, anchor commits list. README voice: 0 em-dashes, 0 banned words. Remaining §4 sections (4.2.1 Hero polish + 4.2.11 Live deployments table refresh + 4.2.12 Security posture refresh) deferred.
