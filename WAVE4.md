...
- 🟡 §1.9 README polish + §4.2.8 engineering tour + §4.2.5 surface refresh. **Polish pass**: 48 em-dashes cleared, Wave 4 entry added (audit iter 15 closed). Banned-word sweep clean (0 violations). **§4.2.8 added**: new "What is actually novel here" section. **§4.2.5 refresh**: surface table 12 → 16 (added Claim links, Storefront, Crowdfund, Encrypted escrow rows + 4 new public-link URL formats in "Send any of these links"). Closes half-baked D5 (stale "twelve" surface count). Remaining §4 sections (4.2.1 Hero polish + 4.2.10 wave-by-wave with date corrections) deferred to focused content session.
