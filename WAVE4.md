...
- 🟡 §1.9 README polish + §4.2.5 + §4.2.8 + §4.2.10 + §4.2.11. **Polish pass**: 48 em-dashes cleared, Wave 4 summary entry added (audit iter 15 closed). **§4.2.5**: surface table 12 → 16, "Send any of these links" updated with 4 new URL formats. **§4.2.8**: "What is actually novel here" engineering tour (11-file passkey-AA flow + 3 engineering choices + BusinessHub pattern + 5 privacy defaults). **§4.2.10**: Wave 3 date corrected, Wave 4 history added with audit-iter-10 narrative + storage coverage + CI uplift. **§4.2.11**: Live deployments table now lists all 4 Wave 4 contracts (ClaimLinks, Storefront, EncryptedCrowdfund, EncryptedEscrow) with Base Sepolia addresses. README voice: 0 em-dashes, 0 banned words. Remaining §4 sections (4.2.1 Hero polish + 4.2.12 Security posture refresh) deferred.
