...
- 🟡 §1.9 README polish + §4.2.5 + §4.2.8 + §4.2.10 + §4.2.11 + §4.2.12. **Polish pass**: 48 em-dashes cleared. **§4.2.5**: surface table 12 → 16. **§4.2.8**: engineering tour added. **§4.2.10**: Wave 4 history. **§4.2.11**: Live deployments adds 4 Wave 4 contracts. **§4.2.12**: Security posture refreshed (12 → 12 rows but updated). New rows: Auction (FHE-tournament + revealWinner), Escrow (no-arbiter dispute fix), Claim links (365-day expiry cap). Updated rows: Contracts row says "all 19 UUPS contracts" tracked + append-via-gap pattern explicit. New row: Test wallets (gitignore for real testnet mnemonics). README voice: 0 em-dashes, 0 banned words. Remaining §4 sections (4.2.1 Hero polish only) deferred.
