...
We ship in waves rather than a continuous trickle. Each wave below has a real date range and points to real commits on `main` — every claim is verifiable.

| Wave | Dates | Themes shipped | Anchor commits |
|------|-------|----------------|----------------|
| **Wave 1 — Foundation** | Mar 29 – Apr 16 | Encrypted vault primitive (shield / unshield, P2P send), the breadth of product surfaces (gifts, stealth, groups, inheritance, creator support), AA contracts (BlankAccount + Factory + Paymaster), P-256 passkeys wired end-to-end. | [`a4c320f`](https://github.com/Pratiikpy/Blank/commit/a4c320f) initial · [`fb11f42`](https://github.com/Pratiikpy/Blank/commit/fb11f42) full release · [`8897baf`](https://github.com/Pratiikpy/Blank/commit/8897baf) AA · [`cca2c42`](https://github.com/Pratiikpy/Blank/commit/cca2c42) passkey wiring |
| **Wave 2 — Hardening + business** | Apr 17 – Apr 30 | Passkey + AA polish (paymaster errors, factory selector fix, broadcast events, modal UX), production stability (lazy imports, COOP, dark-mode), the **P1–P5 hardening sequence** (security audit fix, `__gap` on every UUPS contract, bundle cleanup, architecture enforcement, four-batch contract+frontend hardening + cofhe-shim CI migration), **workspace modes** (Freelancer / Business / Privacy / Full focus), **private invoice escrow** with automatic refund-on-mismatch via `FHE.eq` + `FHE.select`, **proof-of-payment cards** with real explorer links. | [`34b1e8a`](https://github.com/Pratiikpy/Blank/commit/34b1e8a) P1 · [`741ffa0`](https://github.com/Pratiikpy/Blank/commit/741ffa0) P2 · [`0ccd6f8`](https://github.com/Pratiikpy/Blank/commit/0ccd6f8) P3 · [`107fa41`](https://github.com/Pratiikpy/Blank/commit/107fa41) P4 · [`7bfa6ca`](https://github.com/Pratiikpy/Blank/commit/7bfa6ca) P5 · [`2c03451`](https://github.com/Pratiikpy/Blank/commit/2c03451) workspace + invoice escrow |
| **Wave 3 — Partner-grade ship-readiness** | May 1 – present | Production white-screen recovery (CSP relax, manualChunks TDZ, wagmi+viem chunk re-merge), launch of [`/pricing`](https://blank-omega-jade.vercel.app/pricing) + [`/roadmap`](https://blank-omega-jade.vercel.app/roadmap) + [`/blog`](https://blank-omega-jade.vercel.app/blog) (with 4 long-form posts including [Why we built Blank on Fhenix CoFHE](https://blank-omega-jade.vercel.app/blog/why-fhenix-cofhe) and [Choosing FHE over ZK](https://blank-omega-jade.vercel.app/blog/fhe-vs-zk)), GlobalCounter multichain bug fix (Base Sepolia tab now reads correct chain), **allowSender perf pass** — every `FHE.allow(x, msg.sender)` rewritten to `FHE.allowSender(x)` after Fhenix's canonical AI training material flagged it as the slow form, **UUPS-upgraded on both chains** in one shot. | [`925d5e4`](https://github.com/Pratiikpy/Blank/commit/925d5e4) CSP · [`ab4eaf4`](https://github.com/Pratiikpy/Blank/commit/ab4eaf4) /pricing+/roadmap+/blog · [`968b00a`](https://github.com/Pratiikpy/Blank/commit/968b00a) Fhenix post · [`bdf9415`](https://github.com/Pratiikpy/Blank/commit/bdf9415) GlobalCounter fix · [`015701e`](https://github.com/Pratiikpy/Blank/commit/015701e) allowSender · [`c1ffa7e`](https://github.com/Pratiikpy/Blank/commit/c1ffa7e) UUPS rollout |
